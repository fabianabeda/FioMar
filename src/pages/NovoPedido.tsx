        ...
        <Card className="p-6">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value="biquini">Biquíni</SelectItem>
              ...
              <div className="space-y-2">
                ...
                <Select
                  value={formData.modelo_cima}
                  onValueChange={(value) => setFormData({ ...formData, modelo_cima: value })}
                >
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
            ...
            <div className="space-y-2">
              ...
              <Select
                value={formData.modelo_baixo}
                onValueChange={(value) => setFormData({ ...formData, modelo_baixo: value })}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input
                  id="cor_frente"
                  value={formData.cor_frente}
                  onChange={(e) => setFormData({ ...formData, cor_frente: e.target.value })}
              ...
              <div className="space-y-2">
                ...
                <Input
                  id="cor_verso"
                  value={formData.cor_verso}
                  onChange={(e) => setFormData({ ...formData, cor_verso: e.target.value })}
